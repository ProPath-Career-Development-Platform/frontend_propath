  ...
  return (
      ...
      >
        ...
        <CardContent>
          <Typography level="body-sm" fontWeight="lg" textColor="text.tertiary">
            ...
            <Typography level="body-sm" fontWeight="lg" textColor="text.tertiary" sx={{position: 'absolute', right: 15}}>
          ...
          <div>
            ...
            <Button sx={{position: 'absolute' , right: '15px'}} onClick={coursepage}>
              Enroll
            </Button>
          </Box>
        </CardContent>
    ...
    return(
      ...
      >
        ...
        <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 1, marginLeft: '20px', position: 'relative' ,top: '10px'  }}>
          ...
          <Box sx={{ 
                 display : 'flex' , gap : 2
                  ...
                  {content.map((skill, index) => (
                    <Typography key={index} component="span" display="block">
                      <FiberManualRecordIcon sx={{ fontSize: 'small' }} />{skill}
                    </Typography>
                  ))}
                </Box>
          <CardActions
          ...
          >
            <Button variant="solid"  sx={{ maxWidth: '20%', position: 'absolute' , right: '0px' , bottom: '4px' , backgroundColor : 'blue' 
            }} >
              Apply Now <ArrowRightAltIcon sx = {{marginLeft: ' 3px '}}></ArrowRightAltIcon>
            </Button>
          </CardActions>
        </Box>
      </Card>
