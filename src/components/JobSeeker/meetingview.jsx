  ...
  return (
    <Box>
      {num==1 &&(
          ...
          <Modal open={status}  onClose={() => setOpen(false)} sx={{display:'flex' , justifyContent: 'center' , alignItems: 'center'}}>
          <Card
            variant="outlined"
            sx={{
              width: '480px',
          ...
          >
            ...
            <Box sx={{
              ...
              <ModalClose/>
              <Typography sx={{marginLeft:'10px'}} level="title-lg">Interview Scheduler</Typography>
              <Typography sx={{marginLeft:'10px', marginTop:'10px'}} level="body-sm">
              Please select a preferred date and time
              </Typography>
            <Typography sx={{marginLeft:'7px', fontWeight: 500, marginBottom: '10px'}} level="body-sm"> <LocationOn></LocationOn>4th floor,Sysco Labs, Colombo </Typography>
              <hr/>
          ...
          <Button sx={{width: '30%' , display:'flex' , justifyContent: 'center' , marginLeft: '70%' , marginTop: '20px'}} onClick={()=> {
            setNum(2);
