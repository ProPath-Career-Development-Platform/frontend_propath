            ...
            >
              ...
              <Card orientation='horizontal' sx={{m:'auto', display:{xs:'none',sm:'flex'}}}>
                ...
                <CardContent sx={{ display:'flex', flexDirection:'column', justifyContent:'center', alignContent:'center', p:5,gap:2}}>
                    ...
                    <Typography level='h2'>We looked really hard</Typography>
                    <Typography level='body-md'>But it appears the page you seek doesen't exist anymore.</Typography>
                    <Button variant='soft' color='primary' sx={{width:'100px'}} onClick={() => navigate(-2)}>Go back</Button>
