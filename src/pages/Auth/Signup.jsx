  ...
  return (
    <div className="flex items-center justify-center w-full h-screen bg-gradient-to-r from-purple-500 via-purple-300 to-purple-200 overflow-hidden">
      <div className="flex items-center justify-center w-full h-full lg:w-3/4">
        <div className="flex w-full max-w-[800px] rounded-3xl border-2 border-gray-300 bg-violet-100">
          ...
          <div className="w-1/2 px-6 py-12">
            ...
            <div className="mt-8">
              ...
              <div className="flex flex-col mt-4">
                <button className="w-full bg-[#6756a8] text-white py-2 rounded-xl text-lg transition duration-300 ease-in-out hover:bg-[#553e97]">Sign Up</button>
              </div>
              ...
              <div className="flex justify-center items-center mt-4">
                <button className="flex items-center justify-center w-full bg-violet-200 text-black py-2 rounded-xl text-lg transition duration-300 ease-in-out hover:bg-gray-200">
