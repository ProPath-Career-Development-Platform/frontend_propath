      ...
      <Box sx={{ backgroundColor: "#3f067a", width: "100%", height: "60%" }}>
        <Box sx={{ width: "60%", marginTop: "3%", marginBottom: "5%" }}>
          <Box sx={{ marginLeft: "6%", marginTop: "2%" }}>
            <Typography
              sx={{ color: "white", fontSize: 25, fontWeight: "bold" }}
            >
              {headline.title}
            </Typography>
          </Box>
          ...
          >
            <Typography sx={{ color: "white", fontSize: 13 }}>
              <GroupAddIcon sx={{ color: "white", marginRight: "5px" }} />
              381 enrolled{" "}
            </Typography>
            <Typography sx={{ color: "white", fontSize: 13 }}>
              {" "}
              <WhatshotIcon sx={{ color: "white", marginRight: "4px" }} />
              54 remaining
            </Typography>
          </Box>
          <Box sx={{ marginLeft: "6%", marginTop: "8px" }}>
      ...
      <Box>
        ...
        <Box sx={{ width: "60%", marginTop: "40px" }}>
          <Box sx={{ width: "100%", marginTop: "12px", marginBottom: "12px" }}>
            <Typography sx={{ fontWeight: 500, fontSize: "25px" }}>
              Who should learn this free Flutter course?
            </Typography>
          </Box>
          <Box
            sx={{
        ...
        <Box sx={{ width: "60%" }}>
          <Box sx={{ width: "100%", marginTop: "40px", marginBottom: "12px" }}>
            <Typography sx={{ fontWeight: 500, fontSize: "25px" }}>
              What will you learn from this flutter course
            </Typography>
          </Box>
